...
setup(
    ...
    url='https://github.com/dholigum/acoss',
    author='Modified by Arul, Original by Albin Correya, Furkan Yesiler, Chris Traile, Philip Tovstogan, and Diego Silva',
    ...
    project_urls={
        'Source': 'https://github.com/dholigum/acoss',
        'Tracker': 'https://github.com/dholigum/acoss/issues',
    },
